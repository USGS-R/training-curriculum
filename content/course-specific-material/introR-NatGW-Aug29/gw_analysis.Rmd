...
# load the data and metadata
library(XLConnect)
workbook <- loadWorkbook('gwlevels.xlsx')
gwlevels <- readWorksheet(workbook, 'gwlevels')
gwsiteinfo <- readWorksheet(workbook, 'gwsiteinfo', startRow = 3, startCol = 2)
paraminfo <- readWorksheet(workbook, 'paraminfo')
