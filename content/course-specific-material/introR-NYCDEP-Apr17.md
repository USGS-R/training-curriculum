---
date: 2017-04-11
slug: introR-NYCDEP-Apr17
title: New York City DEP
menu:
  main:
    parent: Course Specific Material
    weight: 1
---
April 11th - 13th in Kingston, NY

### Installation

Your IT group should have everything installed prior to the course.
...
Mike McHale (<mmchale@usgs.gov>)

David Watkins (<wwatkins@usgs.gov>)

### Lesson scripts

There will be a zip file here that contains the project folder and `.Rproj` file with the scripts that the instructors created in the class.
