...
The previous section discussed how to format R Markdown (`.Rmd` ) files and knit them to Markdown files (`.md`). README files are just regular `.md`, not `.Rmd`. You can create the `.md` from scratch. Most of the markdown syntax is similar to R Markdown, but can differ somewhat. See [GitHub's markdown style guide](https://guides.github.com/features/mastering-markdown/) for more information. If you will be including a lot of R code and output in your README, you can create a `README.Rmd` and knit to get the `README.md` since regular `.md` cannot evaluate R code.
