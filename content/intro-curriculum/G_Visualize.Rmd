...
```{r pch_col_examp, warning=FALSE, message=FALSE}
...
```{r par_example, warning=FALSE, message=FALSE}
...
```{r legend_example, warning=FALSE, message=FALSE}
...
```{r add_features_example, warning=FALSE, message=FALSE}
...
```{r axis_example, warning=FALSE, message=FALSE}
...
```{r multiple_plots_example, warning=FALSE, message=FALSE}
