...
opts_chunk$set(
  echo=TRUE,
  fig.path="intro-curriculum/static/Visualize/",
  fig.width = 6,
  fig.height = 6,
  fig.cap = "TODO"
)
...
```{r pch_col_examp, warning=FALSE, message=FALSE, fig.cap="Dissolved oxygen versus flow for estimated and erroneous flows"}
...
```{r par_example, warning=FALSE, message=FALSE, fig.cap="Dissolved oxygen versus erroneous flows with green background"}
...
```{r legend_example, warning=FALSE, message=FALSE, fig.cap="Dissolved oxygen versus flow for estimated and erroneous flows with legend"}
...
```{r add_features_example, warning=FALSE, message=FALSE, fig.cap=c("x squared curve", "sine curve", "plot with a line, rectangle, and triangle")}
...
```{r axis_example, warning=FALSE, message=FALSE, fig.cap=c("Water temperature versus flow with a second y-axis", "Water temperature versus flow with logged x axis and second y and x axes")}
...
```{r multiple_plots_example, warning=FALSE, message=FALSE, fig.cap="One figure with 4 different boxplots"}
