...
opts_chunk$set(
  echo=TRUE,
  fig.path="intro-curriculum/static/ggplot2/",
  fig.width = 6,
  fig.height = 6,
  fig.cap = "TODO"
)
...
```{r ggplot_install, warning=FALSE, message=FALSE}
...
```{r ggplot_examp, warning=FALSE, message=FALSE, fig.cap="Blank ggplot2 plot"}
...
```{r points_examp, warning=FALSE, message=FALSE, fig.cap=c("ggplot2 scatter plot", "ggplot2 scatter plot rendered from object")}
...
```{r ion_labels, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with title and xy axis labels"}
...
```{r ion_colors, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter with colors based on Flow code and point type based on site"}
qtemp_scatter <- qtemp_scatter +
...
```{r ion_loess, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with default smooth line"}
qtemp_scatter + geom_smooth()
```

Or we could add a simple linear regression line with:

```{r ion_lm, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with linear regression line"}
qtemp_scatter + geom_smooth(method="lm")
```

And if we are interested in the regressions by group we could do it this way.

```{r ion_lm_groups, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with linear regression line grouped by site"}
qtemp_scatter + geom_smooth(method="lm", aes(group=site_no))
```

Or, if we wanted our regression lines to match the color.

```{r ion_lm_color, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with linear regression line colored by Flow code"}
...
```{r gg_box_examp, warning=FALSE, message=FALSE, fig.cap="ggplot2 boxplot of dissolved oxygen by site"}
...
```{r gg_hist_examp, warning=FALSE, message=FALSE, fig.cap="ggplot2 histogram of pH"}
...
```{r gg_bar_examp2, warning=FALSE, message=FALSE, fig.cap="ggplot2 barplot of average discharge by site"}
...
```{r themes_examp, warning=FALSE, message=FALSE, fig.cap="recreated ggplot2 scatter plot of water temperature versus flow with color based on Flow code and point type based on site"}
...
```{r themes_examp_custom, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with custom theme"}
...
```{r themes_examp_stock, warning=FALSE, message=FALSE, fig.cap=c("ggplot2 scatter plot with black and white theme", "ggplot2 scatter plot with classic theme")}
...
```{r themes_examp_polished, warning=FALSE, message=FALSE, fig.cap="ggplot2 scatter plot with customized black and white theme, plus smooth curve, color/shaped points, a title, and xy axis labels"}
...
```{r facet_grid_example, warning=FALSE, message=FALSE, fig.cap=c("ggplot2 scatter plot of water temperature versus discharge", "ggplot2 faceted scatter plot with rows for sites", "ggplot2 faceted scatter plot with rows for sites and columns for flow code")}
