...
```{r ggplot_examp, warning=FALSE, message=FALSE}
...
```{r points_examp, warning=FALSE, message=FALSE}
...
```{r ion_labels, warning=FALSE, message=FALSE}
...
```{r ion_colors, warning=FALSE, message=FALSE}
qtemp_scatter <- qtemp_scatter +
...
```{r gg_box_examp, warning=FALSE, message=FALSE}
...
```{r gg_hist_examp, warning=FALSE, message=FALSE}
...
```{r gg_bar_examp2, warning=FALSE, message=FALSE}
...
```{r themes_examp, warning=FALSE, message=FALSE}
...
```{r themes_examp_custom, warning=FALSE, message=FALSE}
...
```{r themes_examp_stock, warning=FALSE, message=FALSE}
...
```{r themes_examp_polished, warning=FALSE, message=FALSE}
...
```{r facet_grid_example, warning=FALSE, message=FALSE}
