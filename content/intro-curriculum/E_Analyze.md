...
```
    ...
    ## t = 0.17392, df = 840.97, p-value = 0.862
    ## alternative hypothesis: true difference in means is not equal to 0
    ## 95 percent confidence interval:
    ##  -95.60298 114.19313
    ## sample estimates:
...
```
    ...
    ## t = -12.586, df = 1824, p-value < 2.2e-16
...
```
    ...
    ## Flow     1.0000000 -0.2815919 -0.3103776  0.2460579 -0.2815919
    ## Wtemp   -0.2815919  1.0000000  0.1842554 -0.2843341  1.0000000
    ## pH      -0.3103776  0.1842554  1.0000000  0.3358866  0.1842554
    ## DO       0.2460579 -0.2843341  0.3358866  1.0000000 -0.2843341
    ## Wtemp_F -0.2815919  1.0000000  0.1842554 -0.2843341  1.0000000
...
```
    ...
    ## -4.7031 -0.6643 -0.0873  0.6895  5.0608 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) 10.182140   0.187432   54.32   <2e-16 ***
    ## Wtemp       -0.115101   0.009145  -12.59   <2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 1.23 on 1824 degrees of freedom
    ##   (113 observations deleted due to missingness)
    ## Multiple R-squared:  0.07991,    Adjusted R-squared:  0.0794 
    ## F-statistic: 158.4 on 1 and 1824 DF,  p-value: < 2.2e-16
...
```
    ...
    ## Residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -4.6245 -0.6385 -0.0251  0.6331  5.0376 
    ## 
    ## Coefficients:
    ##               Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)  9.689e+00  1.946e-01  49.798  < 2e-16 ***
    ## Wtemp       -9.425e-02  9.373e-03 -10.056  < 2e-16 ***
    ## Flow         2.346e-04  2.964e-05   7.913 4.33e-15 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 1.21 on 1823 degrees of freedom
    ##   (113 observations deleted due to missingness)
    ## Multiple R-squared:  0.1105, Adjusted R-squared:  0.1095 
    ## F-statistic: 113.2 on 2 and 1823 DF,  p-value: < 2.2e-16
