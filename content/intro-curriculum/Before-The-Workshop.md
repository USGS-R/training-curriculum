...
Type in your PR credentials and click yes (or have your IT rep install with Admin privileges). ![Run as admin](../static/img/install_open_as_admin.png)
...
Double-click the installer. It will ask for your administrator credentials to install (you might need to have your IT rep install again). Accept all the default options for the RStudio install. ![RStudio install screen](../static/img/install_rstudio.png)
...
![Dialog box behind](../static/img/personal_library_dialog.png)
...
![Console output](../static/img/general_pkg_output.png)
...
![Update your packages](../static/img/update_pkgs.png)
