...
```{r plot_examp, warning=FALSE, message=FALSE}
...
```{r plot_examp_2, warning=FALSE, message=FALSE}
plot(intro_df$Wtemp_Inst, intro_df$DO_Inst,
...
```{r pairs_examp, warning=FALSE, message=FALSE}
...
```{r boxplot_examp, warning=FALSE, message=FALSE}
...
```{r boxplot_grps_examp, warning=FALSE, message=FALSE}
...
```{r base_hist_examp, warning=FALSE, message=FALSE}
...
```{r cdf_examp, warning=FALSE, message=FALSE}
