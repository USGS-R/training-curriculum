...
opts_chunk$set(
  echo=TRUE,
  fig.path="intro-curriculum/static/AnalyzeII/",
  fig.width = 6,
  fig.height = 6
)
```
...
```{r flow_history_example, warning=FALSE, message=FALSE}
...
```{r plotFourStats_example, warning=FALSE, message=FALSE}
...
```{r Choptank_noWRTDS_plotexample, warning=FALSE, message=FALSE}
