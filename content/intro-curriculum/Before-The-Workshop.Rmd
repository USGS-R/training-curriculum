...
![Run as admin](../static/img/install_open_as_admin.png)
...
![Install Destination screen](../static/img/install_destination.png)

At the "Select Components" screen, you can accept the default and install both 32-bit and 64-bit versions.
![Select Architecture](../static/img/install_arch_window.png)

At this screen, uncheck 'Create a desktop icon' because non-admin users in Windows will be unable to delete it.
![Uncheck desktop icon](../static/img/install_tasks.png)
...
![RStudio install screen](../static/img/install_rstudio.png)
