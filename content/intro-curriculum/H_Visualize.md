...
<img src='/intro-curriculum/static/ggplot2/ggplot_examp-1.png'/ alt='/Blank ggplot2 plot'/>
...
<img src='/intro-curriculum/static/ggplot2/points_examp-1.png'/ alt='/ggplot2 scatter plot'/>
...
<img src='/intro-curriculum/static/ggplot2/points_examp-2.png'/ alt='/ggplot2 scatter plot rendered from object'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_labels-1.png'/ alt='/ggplot2 scatter plot with title and xy axis labels'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_colors-1.png'/ alt='/ggplot2 scatter with colors based on Flow code and point type based on site'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_loess-1.png'/ alt='/ggplot2 scatter plot with default smooth line'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_lm-1.png'/ alt='/ggplot2 scatter plot with linear regression line'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_lm_groups-1.png'/ alt='/ggplot2 scatter plot with linear regression line grouped by site'/>
...
<img src='/intro-curriculum/static/ggplot2/ion_lm_color-1.png'/ alt='/ggplot2 scatter plot with linear regression line colored by Flow code'/>
...
<img src='/intro-curriculum/static/ggplot2/gg_box_examp-1.png'/ alt='/ggplot2 boxplot of dissolved oxygen by site'/>
...
<img src='/intro-curriculum/static/ggplot2/gg_hist_examp-1.png'/ alt='/ggplot2 histogram of pH'/>
...
<img src='/intro-curriculum/static/ggplot2/gg_bar_examp2-1.png'/ alt='/ggplot2 barplot of average discharge by site'/>
...
<img src='/intro-curriculum/static/ggplot2/themes_examp-1.png'/ alt='/recreated ggplot2 scatter plot of water temperature versus flow with color based on Flow code and point type based on site'/>
...
<img src='/intro-curriculum/static/ggplot2/themes_examp_custom-1.png'/ alt='/ggplot2 scatter plot with custom theme'/>
...
<img src='/intro-curriculum/static/ggplot2/themes_examp_stock-1.png'/ alt='/ggplot2 scatter plot with black and white theme'/>

``` r
qtemp_scatter + theme_classic()
```

<img src='/intro-curriculum/static/ggplot2/themes_examp_stock-2.png'/ alt='/ggplot2 scatter plot with classic theme'/>
...
<img src='/intro-curriculum/static/ggplot2/themes_examp_polished-1.png'/ alt='/ggplot2 scatter plot with customized black and white theme, plus smooth curve, color/shaped points, a title, and xy axis labels'/>
...
<img src='/intro-curriculum/static/ggplot2/facet_grid_example-1.png'/ alt='/ggplot2 scatter plot of water temperature versus discharge'/>
...
<img src='/intro-curriculum/static/ggplot2/facet_grid_example-2.png'/ alt='/ggplot2 faceted scatter plot with rows for sites'/>
...
<img src='/intro-curriculum/static/ggplot2/facet_grid_example-3.png'/ alt='/ggplot2 faceted scatter plot with rows for sites and columns for flow code'/>
