...
```{r sites-data-plot, addToggle="ON", message=FALSE, warning=FALSE}
library(sbtools)
...
```{r read-intermediate, include=FALSE}
...
```{r automate-plots-publish, addToggle="ON"}
