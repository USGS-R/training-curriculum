...
library(htmlTable)
htmlTable(data.frame(Name, Abbreviation), caption="<caption>Table 13. Water-use category names and abbreviations.</caption>",
...
```{r eval=TRUE, echo=FALSE, message=FALSE, results='asis'}
makeArgDefTable("readNWISuv", table.num=14)
```
