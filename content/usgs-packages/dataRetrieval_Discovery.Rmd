...
We are now down to just `r prettyNum(nrow(sites_sc_stream_temp), big.mark=",")` sites, much less than our original `r prettyNum(nrow(sites_sc), big.mark=",")`. Downloading NWIS data will be covered in the next section, [readNWIS](/usgs-packages/dataRetrieval-readNWIS).
