...
setupCourseRmd(slug = "dataRetrieval-discovery")
```
...
```{r sc_streamtemp_sites_map, message=FALSE, warning=FALSE, fig.cap="Geographic locations of NWIS South Carolina stream sites with temperature data", fig.scap="Map of South Carolina stream temp sites"}
